...
class PostItemStepTwo extends StatefulWidget {
  const PostItemStepTwo({
    Key? key,
  }) : super(key: key);

  @override
  _PostItemStepTwoState createState() => _PostItemStepTwoState();
}

class _PostItemStepTwoState extends State<PostItemStepTwo> {
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    Navigator.of(context)
                        .pushNamed(Routes.postItemStepThreeScreenRouteName);
                  },
