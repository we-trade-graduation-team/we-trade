...
final Map<String, WidgetBuilder> routes = {
  ...
  FollowScreen.routeName: (context) => const FollowScreen(),
  ...
  HidePostScreen.routeName: (context) => const HidePostScreen(),
  WishListScreen.routeName: (context) => const WishListScreen(),
  DetailScreen.routeName: (context) => const DetailScreen(),
  RateForTrading.routeName: (context) => const RateForTrading(),
};
